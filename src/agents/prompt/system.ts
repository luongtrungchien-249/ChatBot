 ...
 *   2. Instruction prompt  (instructions.ts) HANG SO theo tung tac vu.
 *   3. Conversation prompt (builder.ts)      Ghep moi luot: lich su + cau hoi.
 *
 * HANG SO nghia la khong noi suy bat cu bien nao vao day — khong ten nhom, khong
 * ngay gio, khong ten nguoi dung. Thong tin dong di vao block rieng, dat SAU chuoi
 * nay. Ly do la TINH TAI LAP: noi suy bien vao day thi hai nguoi hoi cung mot cau
 * se nhan hai prompt khac nhau, va bo eval mat y nghia.
 *
